...
<div class="container-fluid mt-3">
    <div class="card shadow-sm">
        <div class="card-header bg-dark text-white py-2 text-center">
            <h5 class="mb-0">Catálogo de Parámetros para Firmas</h5>
        </div>
        <div class="card-body p-3">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <form action="{{ route('catalogos.parametros-firmas') }}" method="GET">
                    <div class="input-group input-group-sm" style="width: 350px;">
                        <span class="input-group-text bg-light"><i class="bi bi-search"></i></span>
                        <input type="text"
                            class="form-control"
                            placeholder="Filtrar por nombre, descripción o formato..."
                            name="search"
                            value="{{ request('search') }}">
                        <button class="btn btn-primary" type="submit">Filtrar</button>
                        @if(request('search'))
                        <a href="{{ route('catalogos.parametros-firmas') }}" class="btn btn-outline-secondary" title="Limpiar filtro">
            ...
            <div class="table-responsive">
                <table class="table table-sm table-striped table-hover mb-2 mx-auto" style="width: 95%; margin-top: 15px">
                    ...
                    <tbody>
                        ...
                        <tr class="{{ $parametro->trashed() ? 'table-secondary' : '' }}">
                            <td>{{ $parametro->id }}</td>
            ...
            <div class="d-flex justify-content-between align-items-center mt-3">
                ...
                <nav aria-label="Page navigation">
                    {{ $parametros->onEachSide(1)->links('pagination::bootstrap-4') }}
                </nav>
            </div>
        </div>
    </div>
...
@push('modals')
@include('catalogos.modales.parametro_add')
@include('catalogos.modales.parametro_edit')
@endpush

@section('scripts')
@include('catalogos.scripts.parametros_script')
@endsection
