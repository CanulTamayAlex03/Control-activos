...
<div class="container-fluid px-0">
    <div class="row align-items-center mb-2 mx-0">
        <div class="col-md-8 px-0">
            <h5 class="mb-0 text-secondary">
                <i class="fas fa-edit me-2"></i>Editar Activo #{{ $activo->numero_inventario }}
            </h5>
        </div>
        <div class="col-md-4 text-end px-0">
            <a href="{{ route('activos.show', $activo->folio) }}" class="btn btn-secondary btn-sm">
    ...
    <div class="card border shadow-sm">
        <div class="card-header py-1 px-2 bg-light">
            <h6 class="mb-0">
                <i class="fas fa-cube me-1"></i>Formulario de Edición
            </h6>
        </div>
        <form action="{{ route('activos.update', $activo->folio) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="section-card mb-1">
                    ...
                    <div class="section-body">
                        <div class="row g-2">
                                ...
                                <div class="info-row">
                                    ...
                                    <div class="info-value">
                                        <input type="text" 
                                               ...
                                               class="form-control form-control-sm"
                                               value="{{ old('descripcion_corta', $activo->descripcion_corta) }}"
                                               required
                                ...
                                <div class="info-row">
                                    ...
                                    <div class="info-value">
                                        <textarea name="descripcion_larga" 
                                                  ...
                                                  class="form-control form-control-sm"
                                                  rows="2"
                                                  placeholder="Descripción detallada del activo...">{{ old('descripcion_larga', $activo->descripcion_larga) }}</textarea>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <select name="rubro_id" 
                                            ...
                                            @foreach($rubros as $rubro)
                                                <option value="{{ $rubro->id }}"
                                                    {{ old('rubro_id', $activo->rubro_id) == $rubro->id ? 'selected' : '' }}>
                                                    {{ $rubro->descripcion }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select name="clasificacion_id" 
                                            ...
                                            @foreach($clasificaciones as $clasificacion)
                                                <option value="{{ $clasificacion->id }}" 
                                                    {{ old('clasificacion_id', $activo->clasificacion_id) == $clasificacion->id ? 'selected' : '' }}>
                                        ...
                                        <select name="estado_bien_id" 
                                            ...
                                            @foreach($estadosBien as $estado)
                                                <option value="{{ $estado->id }}"
                                                    {{ old('estado_bien_id', $activo->estado_bien_id) == $estado->id ? 'selected' : '' }}>
                                                    {{ $estado->descripcion }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="info-value">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" 
                                                   ...
                                                   id="es_donacion_no" 
                                                   value="0"
                                                   {{ old('es_donacion', $activo->es_donacion) == 0 ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" 
                                                   ...
                                                   id="es_donacion_si" 
                                                   value="1"
                                                   {{ old('es_donacion', $activo->es_donacion) == 1 ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6" id="donante-field" style="display: {{ old('es_donacion', $activo->es_donacion) == 1 ? 'block' : 'none' }};">
                                <div class="info-row">
                                    ...
                                    <div class="info-value">
                                        <input type="text" 
                                               ...
                                               id="donante"
                                               class="form-control form-control-sm"
                                               value="{{ old('donante', $activo->donante) }}"
                                ...
                                <div class="info-row">
                                    ...
                                    <div class="info-value">
                                        <input type="date" 
                                               ...
                                               class="form-control form-control-sm"
                                               value="{{ old('fecha_adquisicion', $activo->fecha_adquisicion ? $activo->fecha_adquisicion->format('Y-m-d') : '') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-row">
                                    ...
                                    <div class="info-value">
                                        <input type="date" 
                                               name="fecha_registro"
                                               class="form-control form-control-sm"
                                               value="{{ old('fecha_registro', optional($activo->fecha_registro)->format('Y-m-d')) }}">
                                        <small class="text-muted">Fecha de registro del activo</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <select name="proveedor_id" 
                                            ...
                                            @foreach($proveedores as $proveedor)
                                                <option value="{{ $proveedor->id }}"
                                                    {{ old('proveedor_id', $activo->proveedor_id) == $proveedor->id ? 'selected' : '' }}>
                                                    {{ $proveedor->nomcorto }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="info-row">
                                    ...
                                    <div class="info-value">
                                        <input type="text" 
                                               ...
                                               id="numero_factura"
                                               class="form-control form-control-sm"
                                               value="{{ old('numero_factura', $activo->numero_factura) }}"
                                ...
                                <div class="info-row">
                                    ...
                                    <div class="info-value">
                                        <input type="text" 
                                               ...
                                               id="numero_pedido"
                                               class="form-control form-control-sm"
                                               value="{{ old('numero_pedido', $activo->numero_pedido) }}"
                                ...
                                <div class="info-row">
                                    ...
                                    <div class="info-value">
                                        <input type="date" 
                                               ...
                                               id="salida_almacen"
                                               class="form-control form-control-sm"
                                               value="{{ old('salida_almacen', $activo->salida_almacen ? $activo->salida_almacen->format('Y-m-d') : '') }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="info-row">
                                    ...
                                    <div class="info-value">
                                        <textarea name="observaciones" 
                                                  id="observaciones"
                                                  class="form-control form-control-sm"
                                                  rows="2">{{ old('observaciones', $activo->observaciones) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <select name="empleado_id" 
                                            ...
                                            @foreach($empleados as $empleado)
                                                <option value="{{ $empleado->id }}"
                                                    {{ old('empleado_id', $activo->empleado_id) == $empleado->id ? 'selected' : '' }}>
                                                    {{ $empleado->nombre }}
                                                    @if($empleado->no_nomi)
                                ...
                                <div class="info-row">
                                    ...
                                    <div class="info-value">
                                        <input type="date" 
                                               ...
                                               id="fecha_asignacion"
                                               class="form-control form-control-sm"
                                               value="{{ old('fecha_asignacion', $activo->fecha_asignacion ? $activo->fecha_asignacion->format('Y-m-d') : '') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                        ...
                                        <select name="edificio_id" 
                                            ...
                                            @foreach($edificios as $edificio)
                                                <option value="{{ $edificio->id }}"
                                                    {{ old('edificio_id', $activo->edificio_id) == $edificio->id ? 'selected' : '' }}>
                                        ...
                                        <select name="departamento_id" 
                                            ...
                                            @foreach($departamentos as $departamento)
                                                <option value="{{ $departamento->id }}"
                                                    {{ old('departamento_id', $activo->departamento_id) == $departamento->id ? 'selected' : '' }}>
                                ...
                                <div class="info-row">
                                    ...
                                    <div class="info-value">
                                        <select name="ubr_id" 
                                            ...
                                            @foreach($ubrs as $ubr)
                                                <option value="{{ $ubr->id }}"
                                                    {{ old('ubr_id', $activo->ubr_id) == $ubr->id ? 'selected' : '' }}>
                                                    {{ $ubr->descripcion }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select name="eade_id" 
                                            ...
                                            @foreach($eades as $eade)
                                                <option value="{{ $eade->id }}"
                                                    {{ old('eade_id', $activo->eade_id) == $eade->id ? 'selected' : '' }}>
                                                    {{ $eade->descripcion }}
                                                </option>
                                            @endforeach
                                        </select>
            ...
            <div class="card-footer py-1 px-2 bg-light">
                <div class="d-flex justify-content-between">
                    <div>
                        <a href="{{ route('activos.show', $activo->folio) }}" class="btn btn-secondary btn-sm me-2">
                            <i class="fas fa-times me-1"></i> Cancelar
                        </a>
                        <button type="submit" class="btn btn-primary btn-sm">
                            <i class="fas fa-save me-1"></i> Actualizar Activo
                        </button>
                    </div>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function cargarSubrubros(rubroId, subrubroSeleccionado = null) {
            if (!rubroId) {
            ...
            fetch(`/activos/subrubros-por-rubro/${rubroId}`)
                ...
                .then(data => {
                    ...
                    if (subrubroSeleccionado) {
                        subrubroSelect.value = subrubroSeleccionado;
                    }
        ...
        const rubroInicial = '{{ old('rubro_id', $activo->rubro_id) }}';
        const subrubroInicial = '{{ old('subrubro_id', $activo->subrubro_id) }}';
        
        if (rubroInicial) {
            rubroSelect.value = rubroInicial;
            cargarSubrubros(rubroInicial, subrubroInicial);
        }
        ...
        const firstInput = document.querySelector('input:not([readonly]):not([type="radio"]), select:not([readonly]), textarea:not([readonly])');
        if (firstInput) {
            setTimeout(() => {
                firstInput.focus();
            }, 100);
