...
<head>
    <meta charset="UTF-8">
    <title>FRM-24 - BAJA DE ACTIVOS</title>
        ...
        <table>
            ...
            <tr>
                <td class="label">
                    ...
                    <span style="margin-left: 5px;">{{ $activo->departamento->descripcion ?? 'DIRECCIÓN OPERATIVA' }}</span>
                </td>
    ...
    <div class="seccion">
        ...
        <table class="datos-bien">
            ...
            <tr>
                <td>
                    <span style="margin-left: 10px; font-weight: lighter;">
                        {{ $activo->motivo_baja ?? 'Sin observaciones' }}
                    </span>
                </td>
            </tr>
        </table>
