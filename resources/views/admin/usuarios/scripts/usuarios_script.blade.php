    ...
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    if (xhr.status === 422) {
                        ...
                        showToast('error', xhr.responseJSON?.message || 'Error al guardar el usuario');
                    }
                },
                complete: function() {
        ...
        $(document).on('click', '.btn-edit', function() {
            ...
            if (active == 1 || active === '1') {
                ...
                $('#statusHelp').html('<i class="bi bi-info-circle me-1"></i>Desmarca para inactivar el usuario');
            } else {
                $('#edit_active').prop('checked', false);
                $('#statusHelp').html('<i class="bi bi-info-circle me-1"></i>Marca para activar el usuario');
            }
        ...
        $('#updateUserBtn').click(function() {
            ...
            $('#editUserForm').find('.invalid-feedback').hide();
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    if (xhr.status === 422) {
                        ...
                        showToast('error', xhr.responseJSON?.message || 'Error al actualizar el usuario');
                    }
                },
                complete: function() {
